(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Sparkline = factory());
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			this.c = noop;
    			attr(polyline, "stroke", /*line_color*/ ctx[2]);
    			attr(polyline, "fill", /*fill_color*/ ctx[3]);
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*line_color*/ 4) {
    				attr(polyline, "stroke", /*line_color*/ ctx[2]);
    			}

    			if (dirty & /*fill_color*/ 8) {
    				attr(polyline, "fill", /*fill_color*/ ctx[3]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { width = 130 } = $$props;
    	let { height = 30 } = $$props;
    	let { line_color = "#b5ddfa" } = $$props;
    	let { fill_color = "#ecf7fe" } = $$props;
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("line_color" in $$props) $$invalidate(2, line_color = $$props.line_color);
    		if ("fill_color" in $$props) $$invalidate(3, fill_color = $$props.fill_color);
    	...
    	return [width, height, line_color, fill_color, strokeWidth, coordinates, values];
    }
    ...
    class SparkLine extends SvelteElement {
    	...
    	static get observedAttributes() {
    		return ["width", "height", "line_color", "fill_color", "values", "strokeWidth"];
    	}
